...
<div class="navbar">
    ...
    <div class="menu">
        ...
        <a href="../ListarTareasServlet" class="<%= request.getRequestURI().contains("views/listarTareas") ? "active" : "" %>">Gestionar Tareas</a>
        <a href="../ListarUsuariosServlet" class="<%= request.getRequestURI().contains("views/listarUsuarios") ? "active" : "" %>">Gestionar Usuarios</a>
